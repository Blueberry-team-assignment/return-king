...
bool isRightAlign(Timeline timeline) {
  ...
  MainAxisAlignment getMainAlign(Timeline timeline) {
    return isRightAlign(timeline) ? MainAxisAlignment.end : MainAxisAlignment.start;
  }

  CrossAxisAlignment getCrossAlign(Timeline timeline) {
    return isRightAlign(timeline) ? CrossAxisAlignment.end : CrossAxisAlignment.start;
  }